...
export default function VerifyEmailScreen() {
  ...
  const verifyEmail = async () => {
    ...
    try {
      ...
      Toast.show({
        ...
        text2: 'Your account is now fully activated',
      });
  ...
  const resendOtp = async () => {
    ...
    setResending(true);
    try {
      await api.post('/auth/resend-otp', { email, type: 'verification' });
      Toast.show({
        type: 'success',
        text1: 'OTP Sent',
  ...
  const skipVerification = () => {
    Toast.show({
      type: 'info',
      text1: 'Verification Skipped',
      text2: 'You can verify your email later in settings',
    });
    router.replace('/(app)/home');
  };
        ...
        >
          <View style={styles.header}>
            <View style={styles.iconContainer}>
              <MaterialIcons name="email" size={60} color={Colors.primary} />
            </View>
